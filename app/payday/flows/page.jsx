  ...
  return (
    <div className="screen screen--white">
      ...
      <div style={{ padding: '16px 20px 0', flexShrink: 0 }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-tertiary)', marginBottom: 6 }}>Flow 1</div>
        <div style={{ fontSize: 24, fontWeight: 800, color: 'var(--text-primary)', letterSpacing: '-0.3px' }}>Payday</div>
        <div style={{ fontSize: 24, fontWeight: 800, color: 'var(--color-brand)', letterSpacing: '-0.3px' }}>Interception</div>
        <p style={{ fontSize: 14.5, color: 'var(--text-secondary)', lineHeight: 1.55, marginTop: 10 }}>
          DBS locks part of your salary into savings on payday. Walk the main set-up flow, or see what happens when a purchase would break the lock.
        </p>
      </div>
